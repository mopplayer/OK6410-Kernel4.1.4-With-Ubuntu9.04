...
pycentral_version = '0.6.11ubuntu2'
    ...
    def move_files(self):
        ...
        for pversion in pversions:
            if pversion in ('python2.3', 'python2.4', 'python2.5'):
                ...
                # srctop and srctop3 are the old/wrong locations, move these.
                srctop = os.path.join(self.pkgdir, 'usr/lib', pversion, 'site-packages')
                ...
                if os.path.isdir(pkgdbgdir):
                    srcdtop = os.path.join(pkgdbgdir, 'usr/lib', pversion, 'site-packages')
                    srcdtop2 = os.path.join(pkgdbgdir, 'usr/lib', pversion, 'dist-packages')
                    srcdtop3 = os.path.join(pkgdbgdir, 'usr/local/lib', pversion, 'dist-packages')
                    if os.path.isdir(srcdtop2) and (os.path.isdir(srcdtop) or os.path.isdir(srcdtop3)):
                        print 'both directories site-packages and dist-packages exist.'
                    if os.path.isdir(srcdtop):
                        print 'renaming %s to %s' % (srcdtop, srcdtop2)
                        os.rename(srcdtop, srcdtop2)
                    elif os.path.isdir(srcdtop3):
                        print 'renaming %s to %s' % (srcdtop3, srcdtop2)
                        try:
                            os.makedirs(os.path.dirname(srcdtop2))
                        except OSError:
                            pass
                        os.rename(srcdtop3, srcdtop2)
                        while srcdtop3:
                            ...
                            try:
                                ...
                                break
                    srcdtop = os.path.join(pkgdbgdir, 'usr/lib/debug/usr/lib', pversion, 'site-packages')
                    srcdtop2 = os.path.join(pkgdbgdir, 'usr/lib/debug/usr/lib', pversion, 'dist-packages')
