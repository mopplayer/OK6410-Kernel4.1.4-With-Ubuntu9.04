 ...
 * Package name      : perl5
 * Source directory  : .
 * Configuration time: Mon Jan  5 21:46:10 UTC 2009
 * Configured by     : Debian Project
 * Target system     : linux nageia 2.6.27.4 #1 preempt wed nov 5 00:02:36 gmt 2008 armv5tel gnulinux 
 */
 ...
 *	instance.
 */
#define ARCHNAME "arm-linux-gnueabi-thread-multi"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/perl/5.10.0"		/**/
#define SITEARCH_EXP "/usr/local/lib/perl/5.10.0"		/**/
 ...
 */
#define SITELIB "/usr/local/share/perl/5.10.0"		/**/
#define SITELIB_EXP "/usr/local/share/perl/5.10.0"		/**/
#define SITELIB_STEM ""		/**/
