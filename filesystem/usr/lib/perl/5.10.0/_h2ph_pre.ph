...
unless (defined &__ARM_ARCH_5T__) { sub __ARM_ARCH_5T__() { 1 } }
...
unless (defined &__DEC128_DEN__) { sub __DEC128_DEN__() { "0\.000000000000000000000000000000001E\-6143DL" } }
...
unless (defined &__DEC64_MAX_EXP__) { sub __DEC64_MAX_EXP__() { 384 } }

unless (defined &__DEC64_MAX__) { sub __DEC64_MAX__() { "9\.999999999999999E384DD" } }

unless (defined &__DEC64_MIN_EXP__) { sub __DEC64_MIN_EXP__() { -383 } }
...
unless (defined &__GLIBC_MINOR__) { sub __GLIBC_MINOR__() { 9 } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"4\.3\.3\\\ 20081217\\\ \(prerelease\)\"" } }
