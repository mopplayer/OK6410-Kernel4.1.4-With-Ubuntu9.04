...
unless(defined(&_FEATURES_H)) {
    ...
    if((defined (defined(&_ISOC99_SOURCE) ? &_ISOC99_SOURCE : undef) || defined (defined(&_ISOC9X_SOURCE) ? &_ISOC9X_SOURCE : undef) || (defined (defined(&__STDC_VERSION__) ? &__STDC_VERSION__ : undef)  && (defined(&__STDC_VERSION__) ? &__STDC_VERSION__ : undef) >= 199409))) {
    ...
    if(defined (defined(&_FORTIFY_SOURCE) ? &_FORTIFY_SOURCE : undef)  && (defined(&_FORTIFY_SOURCE) ? &_FORTIFY_SOURCE : undef) > 0 &&  &__GNUC_PREREQ (4, 1)  && defined (defined(&__OPTIMIZE__) ? &__OPTIMIZE__ : undef)  && (defined(&__OPTIMIZE__) ? &__OPTIMIZE__ : undef) > 0) {
    ...
    eval 'sub __GLIBC_MINOR__ () {9;}' unless defined(&__GLIBC_MINOR__);
    ...
    if( &__GNUC_PREREQ (2, 7)  && defined (defined(&__OPTIMIZE__) ? &__OPTIMIZE__ : undef)  && !defined (defined(&__OPTIMIZE_SIZE__) ? &__OPTIMIZE_SIZE__ : undef)  && !defined (defined(&__NO_INLINE__) ? &__NO_INLINE__ : undef)  && defined (defined(&__extern_inline) ? &__extern_inline : undef)) {
