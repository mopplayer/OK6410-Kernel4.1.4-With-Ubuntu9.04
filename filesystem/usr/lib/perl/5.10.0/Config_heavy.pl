...
cf_time='Mon Jan  5 21:46:10 UTC 2009'
chgrp=''
chmod='chmod'
chown=''
clocktype='clock_t'
...
config_arg13='-Dsitelib=/usr/local/share/perl/5.10.0'
config_arg14='-Dsitearch=/usr/local/lib/perl/5.10.0'
...
config_arg30='-Dlibperl=libperl.so.5.10.0'
...
gccansipedantic=''
gccosandvers=''
gccversion='4.3.3 20081217 (prerelease)'
...
myuname='linux nageia 2.6.27.4 #1 preempt wed nov 5 00:02:36 gmt 2008 armv5tel gnulinux '
n='-n'
need_va_copy='undef'
