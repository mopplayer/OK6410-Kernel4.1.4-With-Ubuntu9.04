...
unless(defined(&SYS_OABI_SYSCALL_BASE)) {
    sub SYS_OABI_SYSCALL_BASE () {	 &__NR_OABI_SYSCALL_BASE;}
}
unless(defined(&SYS_SYSCALL_BASE)) {
    sub SYS_SYSCALL_BASE () {	 &__NR_SYSCALL_BASE;}
}
...
unless(defined(&SYS_arm_fadvise64_64)) {
    sub SYS_arm_fadvise64_64 () {	 &__NR_arm_fadvise64_64;}
}
unless(defined(&SYS_arm_sync_file_range)) {
    sub SYS_arm_sync_file_range () {	 &__NR_arm_sync_file_range;}
}
unless(defined(&SYS_bdflush)) {
    sub SYS_bdflush () {	 &__NR_bdflush;}
}
unless(defined(&SYS_bind)) {
    sub SYS_bind () {	 &__NR_bind;}
}
...
unless(defined(&SYS_getpeername)) {
    sub SYS_getpeername () {	 &__NR_getpeername;}
}
...
unless(defined(&SYS_getsockname)) {
    sub SYS_getsockname () {	 &__NR_getsockname;}
}
unless(defined(&SYS_getsockopt)) {
    sub SYS_getsockopt () {	 &__NR_getsockopt;}
}
...
unless(defined(&SYS_msgctl)) {
    sub SYS_msgctl () {	 &__NR_msgctl;}
}
unless(defined(&SYS_msgget)) {
    sub SYS_msgget () {	 &__NR_msgget;}
}
unless(defined(&SYS_msgrcv)) {
    sub SYS_msgrcv () {	 &__NR_msgrcv;}
}
unless(defined(&SYS_msgsnd)) {
    sub SYS_msgsnd () {	 &__NR_msgsnd;}
}
...
unless(defined(&SYS_pciconfig_iobase)) {
    sub SYS_pciconfig_iobase () {	 &__NR_pciconfig_iobase;}
}
unless(defined(&SYS_pciconfig_read)) {
    sub SYS_pciconfig_read () {	 &__NR_pciconfig_read;}
}
unless(defined(&SYS_pciconfig_write)) {
    sub SYS_pciconfig_write () {	 &__NR_pciconfig_write;}
}
...
unless(defined(&SYS_recv)) {
    sub SYS_recv () {	 &__NR_recv;}
}
unless(defined(&SYS_recvfrom)) {
    sub SYS_recvfrom () {	 &__NR_recvfrom;}
}
unless(defined(&SYS_recvmsg)) {
    sub SYS_recvmsg () {	 &__NR_recvmsg;}
}
...
unless(defined(&SYS_semctl)) {
    sub SYS_semctl () {	 &__NR_semctl;}
}
unless(defined(&SYS_semget)) {
    sub SYS_semget () {	 &__NR_semget;}
}
unless(defined(&SYS_semop)) {
    sub SYS_semop () {	 &__NR_semop;}
}
unless(defined(&SYS_semtimedop)) {
    sub SYS_semtimedop () {	 &__NR_semtimedop;}
}
unless(defined(&SYS_send)) {
    sub SYS_send () {	 &__NR_send;}
}
...
unless(defined(&SYS_sendmsg)) {
    sub SYS_sendmsg () {	 &__NR_sendmsg;}
}
unless(defined(&SYS_sendto)) {
    sub SYS_sendto () {	 &__NR_sendto;}
}
...
unless(defined(&SYS_setsockopt)) {
    sub SYS_setsockopt () {	 &__NR_setsockopt;}
}
...
unless(defined(&SYS_shmat)) {
    sub SYS_shmat () {	 &__NR_shmat;}
}
unless(defined(&SYS_shmctl)) {
    sub SYS_shmctl () {	 &__NR_shmctl;}
}
unless(defined(&SYS_shmdt)) {
    sub SYS_shmdt () {	 &__NR_shmdt;}
}
unless(defined(&SYS_shmget)) {
    sub SYS_shmget () {	 &__NR_shmget;}
}
unless(defined(&SYS_shutdown)) {
    sub SYS_shutdown () {	 &__NR_shutdown;}
}
...
unless(defined(&SYS_socket)) {
    sub SYS_socket () {	 &__NR_socket;}
}
unless(defined(&SYS_socketpair)) {
    sub SYS_socketpair () {	 &__NR_socketpair;}
}
...
unless(defined(&SYS_sync_file_range2)) {
    sub SYS_sync_file_range2 () {	 &__NR_sync_file_range2;}
}
