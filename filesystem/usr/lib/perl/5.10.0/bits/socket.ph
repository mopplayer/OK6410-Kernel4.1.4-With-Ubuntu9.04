...
unless(defined(&__BITS_SOCKET_H)) {
    ...
    eval 'sub PF_MAX () {35;}' unless defined(&PF_MAX);
    ...
    if((!defined (defined(&__STRICT_ANSI__) ? &__STRICT_ANSI__ : undef)  && (defined(&__GNUC__) ? &__GNUC__ : undef) >= 2) || (defined(&__STDC_VERSION__) ? &__STDC_VERSION__ : undef) >= 199901) {
    }
    if((!defined (defined(&__STRICT_ANSI__) ? &__STRICT_ANSI__ : undef)  && (defined(&__GNUC__) ? &__GNUC__ : undef) >= 2) || (defined(&__STDC_VERSION__) ? &__STDC_VERSION__ : undef) >= 199901) {
	eval 'sub CMSG_DATA {
	    my($cmsg) = @_;
    ...
    if(!defined (defined(&__USE_MISC) ? &__USE_MISC : undef)  && !defined (defined(&__USE_GNU) ? &__USE_GNU : undef)) {
